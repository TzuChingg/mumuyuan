          ...
          <table class="table table-borderless table-light">
            <thead>
                    ...
                    <tbody>
                      <tr v-for="(item, index) in cartsList.carts" :key="index">
                        <td class="text-center align-middle">
                          <a @click.prevent="deleteQuestion(item.id)" class="p-0"
                        ...
                        <td class="fs-5 align-middle">
                          <div class="ms-5 ps-4">
                            <img
                              :src="'/木木苑食材修圖small/' + item.product.image"
              ...
              <tr class="align-middle">
                ...
                <td>
                  <label for="tel" class="form-label d-flex justify-content-center fs-5"
                    >手機號碼</label
                  >
                </td>
                <td>
                ...
                <td>
                  <div class="d-flex justify-content-end">
                    ...
                    >
                      ...
                      <option
                        v-for="(option, index) in user.coupon"
                        :key="index"
                        :value="option.calc"
                      >
                        {{ option.name }}
                    ...
                    <div class="col">
                      ...
                      >
                        <VField
                          ...
                          value="1"
                          rules="required"
                          class="btn-check form-check-input border-primary"
                          id="pepperSalt"
                          v-model="flavor"
                        />
