                  ...
                  <div class="row text-center align-items-center py-3">
                    ...
                    <div class="col-6 ">
                      <button type="button" class="btn btn-primary me-6" data-bs-toggle="modal"
                        :data-bs-target="'#update' + index">修改</button>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="modal-content border-0">
                    ...
                    <div class="modal-footer border-0">
                      ...
                      <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        @click="goDown(journey.id)">確認</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content border-0">
                    ...
                    <div class="modal-footer border-0">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                      <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        @click="update(journey.id, journey.coupon, journey.newsContent)">確認</button>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="cardbody mt-4">
                      ...
                      <div class="d-flex h-25 justify-content-center mt-3 mb-2">
                        <select class="form-select w-50 shadow-none" aria-label="Default select example"
                          ...
                          <option v-for="( coupon, index) in  coupons" :key="index" :value=coupon.id>{{ coupon.title }}
                          </option>
                        </select>
                      </div>
                    </div>
