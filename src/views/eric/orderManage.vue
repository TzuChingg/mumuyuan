              ...
              <div class="accordion-item ">
                <h2 class="accordion-header " :id="'flush-heading' + index">
                  <button class="accordion-button collapsed shadow-none" type="button" data-bs-toggle="collapse"
                    ...
                    <strong class="me-5 fs-4">{{ order.name }}</strong> <span
                      class="ms-5 mt-11 fs-4">手機:{{ order.phone }}</span><span
                      class="ms-5 mt-11 fs-4">日期:{{ order.day }}</span>
                  </button>
                </h2>
                      ...
                      <div class="col">
                        <table class=" table table-striped align-middle table-sm h-100">
                          <tbody>
                            ...
                            <tr>
                              <td class="fs-5"><strong>預計取餐時間:</strong><span class="text-danger">{{ order.time }}</span>
                              </td>
                            </tr>
                            <tr>
                          ...
                          <tfoot>
                            <button type="btn" class="btn btn-primary w-100 mb-1" data-bs-toggle="modal"
                              :data-bs-target="'#ok' + index">接受</button>
                            <button type="btn" class="btn btn-primary w-100 mt-1" data-bs-toggle="modal"
                              :data-bs-target="'#reject' + index">拒絕</button>
                          </tfoot>
                        </table>
                      </div>
                    </div>
                ...
                <div class="modal-content border-0">
                  ...
                  <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                      @click="ok(order.id, order.userId, order.orderNum)">確認</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content border-0">
                  ...
                  <div class="modal-footer border-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                      @click="reject(order.id)">確認</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="accordion-item ">
                <h2 class="accordion-header " :id="'flush-heading' + index">
                  <button class="accordion-button collapsed shadow-none" type="button" data-bs-toggle="collapse"
                    ...
                    <strong class="me-5 fs-4">{{ order.name }}</strong> <span
                      class="ms-5 mt-11 fs-4">手機:{{ order.phone }}</span>
                  </button>
                </h2>
                <div :id="'flush-collapseOne' + index" class="accordion-collapse collapse "
                    ...
                    <div class="row row-cols-2 ">
                      ...
                      <div class="col">
                        <table class=" table table-striped align-middle table-sm h-100">
                          ...
                          <tfoot>
                            <button type="btn" class="btn btn-primary w-100 mt-1" data-bs-toggle="modal"
                              :data-bs-target="'#finish' + index">完成</button>
                          </tfoot>
                        </table>
                      </div>
                    </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content border-0">
                  ...
                  <div class="modal-footer border-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                      @click="pushForCustomer(order.id, order.userId, order.orderNum)">確認</button>
                  </div>
                </div>
              </div>
            </div>
